...
catalogued, four follow-up control studies (A, B/B'/B'', C, F-CKA) run
and reported, and the remaining program (D and E) specified.
The methodologically decisive controls --- Study B, Study B', and the
cross-validated Study B'' --- show that the pilot's headline numbers
