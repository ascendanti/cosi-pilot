\subsection{Study B3 — Cross-Validated Lexical Residualization}
\label{sec:results-study-b-double-prime}

Study B2 fit ridge regression and computed residuals on the same set
of $600$ probes, which permits a reviewer concern: the $94$--$97\%$
in-sample variance removal at $V = 455$ TF-IDF + template features
and $N = 600$ may include substantial overfitting. Study B3 is the
...
than Study B2 indicated, but it remains substantial.

\begin{table}[h]
\centering
\caption{Study B3 cross-validated lexical residualization,
...
respectively, smaller still than the in-sample Study B2 deltas.}
\end{table}

\paragraph{What Study B3 establishes.}

\begin{enumerate}
    \item \textbf{Study B2s in-sample numbers were inflated by
...
Study B2 overstates the magnitude of the negative finding by
...
intervals reported. The Study B2 protocol should not be cited as a
diagnostic standard.
