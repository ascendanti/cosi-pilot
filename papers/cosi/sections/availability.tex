...
described in this paper are publicly released at:
\begin{center}
\url{https://github.com/ascendanti/cosi-pilot}
\end{center}
A Zenodo deposit assigning a DOI to the activation-matrix dataset
($\sim 57$\,MB across Phase~0 and Phase~1) and to the pre-registration
packet is to be created from the same repository before peer-reviewed
journal submission. The repository is organized at the following
relative paths:
