\subsection{Study B2 — Lexical-Residual Alignment}
...
Study B2 is the direct follow-up: if we explicitly residualize
...
\begin{table}[h]
\centering
\caption{Study B2 lexical-residual alignment. Lexical and template
...
\paragraph{What Study B2 establishes.}
...
\begin{enumerate}
    ...
    \item \textbf{A small cross-model signal survives lexical control.}
        ...
        discriminated by Study B2 alone.
\end{enumerate}
...
range. Study B2 demonstrates that those magnitudes do not licence
